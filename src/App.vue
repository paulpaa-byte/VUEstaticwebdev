...
<script>
      ...
      const DEFAULT_SITE_CONTENT = {
        ...
        about: {
          ...
          summary: "Gleeds is a global property and construction consultancy that provides professional advice and management services across the built environment.",
          body: [
            "Gleeds is a global property and construction consultancy that provides professional advice and management services across the built environment. The company works with clients throughout the lifecycle of construction and property projects, from planning and cost management through project delivery and sustainability. Gleeds operates as a built-environment consultancy rather than as a construction contractor that physically builds projects itself.",
            "In simple terms, Gleeds helps clients plan, manage, control, and deliver construction and property projects. Its work includes project management, cost management, quantity surveying, advisory services, building surveying, development management, facilities management, health and safety, project controls, digital services, sustainability and ESG, and procurement and contract management.",
            "Gleeds has a long history dating back to 1875 and has expanded internationally across the UK, Europe, China, the United States, the Middle East, India, and Asia-Pacific. Today, the company has more than 2,800 employees, 29 countries, 78 offices, and 150 years of experience. In India, Gleeds has been operating since 2008 with 500+ employees, six regional offices, and more than 360 million square feet of projects managed, including major projects in Bengaluru such as Brigade Tech Gardens."
          ],
          media: [
            {
